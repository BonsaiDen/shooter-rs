...
impl Ship {
    ...
    pub fn create_entity(scale: f32) -> Entity<SharedState, SharedLevel, DefaultRenderer> {
        Entity::new(
...
impl BaseEntity<SharedState, SharedLevel> for Ship {
    ...
    fn apply_input(
        &mut self,
        level: &Level<SharedState, SharedLevel>,
        state: &mut SharedState, input: &EntityInput,
        dt: f32
    ) {
